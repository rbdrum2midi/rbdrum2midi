...
void init_rb4_kit(MIDIDRUM* MIDI_DRUM)
{
    ...
    MIDI_DRUM->buf_indx[BLACK_BASS] = 17;
...
void cb_irq_rb4(struct libusb_transfer *transfer)
{
    ...
    get_state(MIDI_DRUM,BLUE_CYMBAL);
    get_state(MIDI_DRUM,GREEN_CYMBAL);
